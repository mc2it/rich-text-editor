...
class TimestampEditing extends Plugin {
	 ...
	 * @param {import("@ckeditor/ckeditor5-engine").Element} modelItem The model item.
	 * @param {import("@ckeditor/ckeditor5-engine").DowncastWriter} viewWriter The view writer.
	 */
...
class TimestampUI extends Plugin {
	 ...
	 */
	init() {
		add("es", {Timestamp: "Marca de tiempo"});
		add("fr", {Timestamp: "Horodatage"});
